...
SENSOR_FEATURES = {
    "Illuminance.Room518a_Ceiling": "Illuminance",
    "TSL1_LowerScreen_spec.Room518a_WP1": "TSL1_LowerScreen_spec",
    "TSL1_LowerScreen_spec.Room518a_WP2": "TSL1_LowerScreen_spec",
    "TSL2_Keyboard_spec.Room518a_WP1": "TSL2_Keyboard_spec",
    "TSL2_Keyboard_spec.Room518a_WP2": "TSL2_Keyboard_spec",
    "TSL3_UpperScreen_spec.Room518a_WP1": "TSL3_UpperScreen_spec",
    "TSL3_UpperScreen_spec.Room518a_WP2": "TSL3_UpperScreen_spec",
    "TSL4_UpperScreen_spec.Room518a_WP1": "TSL4_UpperScreen_spec",
    "TSL4_UpperScreen_spec.Room518a_WP2": "TSL4_UpperScreen_spec",
}
...
def save_csv(data_points):
    filename = "sensor_data_ws_http.csv"
    if not data_points:
