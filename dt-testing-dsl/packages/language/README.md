...
- [src/dt-testing-dsl.langium](src/dt-testing-dsl.langium) -  The grammar definition of your language
- [src/dt-testing-dsl-module.ts](src/dt-testing-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/dt-testing-dsl-validator.ts](src/dt-testing-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/dt-testing-dsl.monarch.ts](src/syntaxes/dt-testing-dsl.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/dt-testing-dsl.tmLanguage.json](syntaxes/dt-testing-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
